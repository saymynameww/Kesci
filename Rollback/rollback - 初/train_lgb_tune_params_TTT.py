...
train_path = 'E:/Kesci-data-dealt/train_and_test/train.csv'
test_path = 'E:/Kesci-data-dealt/train_and_test/test.csv'
...
gbm.save_model('E:/1Kesci/model/lgb_model.txt')
...
df_result.to_csv('E:/1Kesci/result/lgb_result.csv', index=False)
