...
#    get_repeated_video_count_stat['video_count'+suffix] = get_repeated_video_count.groupby(['author_id'],as_index=False)['video_id'].agg({'video_count'+suffix:'count'})['video_count'+suffix]
    ...
    get_page_slide_count = activity.groupby(['author_id']).agg({'author_id':'mean'})
    get_action_slide_count = activity.groupby(['author_id']).agg({'author_id':'mean'})
...
#    feature = pd.merge(feature,action5_everyday_count_stat,how='left',on='user_id')
    del action_everyday_count,action0_everyday_count_stat,action1_everyday_count_stat,action2_everyday_count_stat,action3_everyday_count_stat
    # ,action4_everyday_count_stat,action5_everyday_count_stat
    gc.collect()
