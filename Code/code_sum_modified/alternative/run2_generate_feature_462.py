...
#    author_video_count = activity.groupby(['author_id','video_id']).agg({'author_id':'mean','video_id':'count'}).groupby(['author_id']).agg({'author_id':'mean','video_id':'count'}).rename({'author_id':'user_id','video_id':'author_video_count'},axis=1)
...
#    author_get_action_percent['author_get_action5_pct'] = author_get_action_percent['author_get_action5_count']/author_get_action_percent['author_get_activity_count']
    ...
    return activity_total_count,page_percent,action_percent,video_id_most,author_id_most,author_video_count,author_get_activity_count,author_get_action_percent,author_get_page_percent
...
def get_activity_feature(activity):
    ...
    activity_total_count_all,page_percent_all,action_percent_all,video_id_most_all,author_id_most_all,author_video_count_all,author_get_activity_count_all,author_get_action_percent_all,author_get_page_percent_all=activity_slide_window(activity)
    activity_total_count_1,page_percent_1,action_percent_1,video_id_most_1,author_id_most_1,author_video_count_1,author_get_activity_count_1,author_get_action_percent_1,author_get_page_percent_1=activity_slide_window(activity[(activity['activity_day']>=end_day) & (activity['activity_day']<=end_day)])
    activity_total_count_2,page_percent_2,action_percent_2,video_id_most_2,author_id_most_2,author_video_count_2,author_get_activity_count_2,author_get_action_percent_2,author_get_page_percent_2=activity_slide_window(activity[(activity['activity_day']>=end_day-1) & (activity['activity_day']<=end_day)])
    activity_total_count_3,page_percent_3,action_percent_3,video_id_most_3,author_id_most_3,author_video_count_3,author_get_activity_count_3,author_get_action_percent_3,author_get_page_percent_3=activity_slide_window(activity[(activity['activity_day']>=end_day-2) & (activity['activity_day']<=end_day)])
    activity_total_count_5,page_percent_5,action_percent_5,video_id_most_5,author_id_most_5,author_video_count_5,author_get_activity_count_5,author_get_action_percent_5,author_get_page_percent_5=activity_slide_window(activity[(activity['activity_day']>=end_day-4) & (activity['activity_day']<=end_day)])
    activity_total_count_7,page_percent_7,action_percent_7,video_id_most_7,author_id_most_7,author_video_count_7,author_get_activity_count_7,author_get_action_percent_7,author_get_page_percent_7=activity_slide_window(activity[(activity['activity_day']>=end_day-6) & (activity['activity_day']<=end_day)])
    activity_total_count_10,page_percent_10,action_percent_10,video_id_most_10,author_id_most_10,author_video_count_10,author_get_activity_count_10,author_get_action_percent_10,author_get_page_percent_10=activity_slide_window(activity[(activity['activity_day']>=end_day-9) & (activity['activity_day']<=end_day)])
    ...
    feature = pd.merge(feature,video_id_most_all,how='left',on='user_id')
    feature = pd.merge(feature,author_id_most_all,how='left',on='user_id')
    ...
    feature = pd.merge(feature,video_id_most_1,how='left',on='user_id')
    feature = pd.merge(feature,author_id_most_1,how='left',on='user_id')
    ...
    feature = pd.merge(feature,video_id_most_2,how='left',on='user_id')
    feature = pd.merge(feature,author_id_most_2,how='left',on='user_id')
    ...
    feature = pd.merge(feature,video_id_most_3,how='left',on='user_id')
    feature = pd.merge(feature,author_id_most_3,how='left',on='user_id')
    ...
    feature = pd.merge(feature,video_id_most_5,how='left',on='user_id')
    feature = pd.merge(feature,author_id_most_5,how='left',on='user_id')
    ...
    feature = pd.merge(feature,video_id_most_7,how='left',on='user_id')
    feature = pd.merge(feature,author_id_most_7,how='left',on='user_id')
    ...
    feature = pd.merge(feature,video_id_most_10,how='left',on='user_id')
    feature = pd.merge(feature,author_id_most_10,how='left',on='user_id')
